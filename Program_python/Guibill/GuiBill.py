...
def main():
    ...
    watermark = Image.open('/Users/pection/Programing/MNfurniture/Bill/Template/PAID.png')
    ...
    if(len(Data["PhotoPath"]))<5:
        Data["PhotoPath"]="/Users/pection/Programing/MNfurniture/Bill/Template/48848.jpg"
    ...
    template=cv2.imread("/Users/pection/Programing/MNfurniture/Bill/Template/TemplateBill.jpg")
    template[y_offset:y_offset+img.shape[0], x_offset:x_offset+img.shape[1]] = img

    cv2.imwrite("/Users/pection/Programing/MNfurniture/Bill/PretoPaid/Pretopaid.jpg",template)
    image = Image.open("/Users/pection/Programing/MNfurniture/Bill/PretoPaid/Pretopaid.jpg")
    ...
    image.save("/Users/pection/Programing/MNfurniture/Bill/PretoPaid/Pretopaid2.jpg")
    image2.save("/Users/pection/Programing/MNfurniture/Bill/PretoPaid/Pretopaid2_paid.jpg")
